...
if len(sys.argv) != 2 and len(sys.argv) != 3:
	print "Introduzca una orden válida: create, start, stop, destroy o monitor"
	sys.exit()
elif len(sys.argv) == 3:
...
if orden == 'create':
	...
	# Si se pasa un parámetro aparte de la orden (la orden start precisa un parámetro que indique el número de servidores a arrancar)
	...
	if len(sys.argv) == 2:
		...
		print "Si quiere información sobre una MV en concreto, introduzca su nombre tras la orden monitor"
		print ""
